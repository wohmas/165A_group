...
t.add_query(query.update, test_table, 1, *[1, 1, 1, 1, 1])
t.add_query(query.insert, test_table, *[1, 1, 1, 1, 1])
t.add_query(query.insert, test_table, *[1, 1, 1, 1, 1])
t.add_query(query.insert, test_table, *[1, 1, 1, 1, 1])
t.add_query(query.insert, test_table, *[1, 1, 1, 1, 1])
...
t.add_query(query.update, test_table, 3, *[None, 3, 2, 1, 0])
t.add_query(query.update, test_table, 2, *[None, 2, 1, 1, 4])
t.add_query(query.select, test_table, 2, 0, [1, 1, 1, 1, 1])
t.add_query(query.select_version, test_table, 2, 0, [1, 1, 1, 1, 1], 0)
t.add_query(query.sum, test_table, 0, 1, 0)
t.add_query(query.sum_version, test_table, 0, 1, 0, 0)
t.add_query(query.delete, test_table, 4)
